...
exports.solveLambdaMan = exports.pathSearch = void 0;
const util_1 = require("./util");
const loopGrid = (grid, fn) => {
    let results = [];
...
const pathSearch = (grid, start, end) => {
...
const solveLambdaMan = async (n) => {
    let temp = (await (0, util_1.sendToServer)(`get lambdaman${n}`)).value.split("\n");
    ...
    let curr = loopGrid(grid, (row, col, item) => item === "L" ? [row, col] : null)[0];
    while (npills > 0) {
        ...
        const nextPath = (0, exports.pathSearch)(grid, curr, pill);
    ...
    console.log(path);
    await (0, util_1.sendToServer)(`solve lambdaman${n} ${path}`);
};
exports.solveLambdaMan = solveLambdaMan;
//# sourceMappingURL=lambdaman.js.map